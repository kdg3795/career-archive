...
const coverLetters = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "요구사항이 명확하지 않거나 기존 시스템과 충돌할 때 혼자 판단하기보다 기획 방향을 정확히 반영하기 위해 관련 담당자와 내용을 확인하고, 가능한 방법을 함께 논의합니다. 수정된 요구사항을 다시 정리해 공유하고, 기술적으로 어려운 부분이 생길 경우 단순히 불가능하다고 말하기보다 적용 가능한 대안을 제시합니다.",
