...
const coverLetters = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "경험이 더 쌓이면 개발 일정과 업무 우선순위, 기술적 의사결정과 구성원 간 협업을 함께 조율하는 프로젝트 리더로 역할을 넓히고 싶습니다. 일방적으로 방향을 지시하기보다 의견을 모으고 필요한 결정을 책임지며, 팀원들이 역량을 발휘할 수 있는 환경을 만드는 팀장으로 성장하겠습니다.",
