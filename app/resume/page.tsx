...
const experiences = [
  {
    ...
    description: "교육청 플랫폼의 신규 기능 개발, 기존 기능 개선, 배포 및 운영 유지보수를 담당하고 있습니다.",
  },
  {
    period: "2020. 11 — 2023. 06",
    company: "(주)모바일인포",
    position: "웹퍼블리셔 · 2년 8개월",
    description: "HTML, CSS, JavaScript를 활용한 고객사 맞춤형 홈페이지 제작과 운영·유지보수를 담당했습니다.",
  },
];
...
const coverLetters = [
  {
    ...
    paragraphs: [
      ...
      "이후 공공·교육기관 프로젝트를 수행하며 실무 경험을 쌓았습니다. 처음에는 주어진 기능을 정확하게 구현하는 것이 가장 중요한 목표였지만, 여러 프로젝트의 개발과 운영을 경험하면서 개발자의 역할은 단순히 코드를 작성하는 것에 그치지 않는다는 것을 배웠습니다.",
      ...
      "공공기관 프로젝트에서는 하나의 기능도 여러 담당자의 협의와 검토를 거치는 경우가 많았습니다. 기획자, 퍼블리셔, 개발자, 인프라 담당자와 협업하면서 요구사항을 정확하게 이해하고 자신의 의견을 명확하게 전달하는 커뮤니케이션의 중요성을 배웠습니다.",
  ...
  },
  {
    ...
    paragraphs: [
      "저의 가장 큰 강점은 사람들과 자연스럽게 어울리고 적극적으로 소통하는 능력입니다. 먼저 다가가 대화를 시작하는 편이며, 새로운 환경에서도 구성원들과 빠르게 관계를 형성합니다. 이러한 성격은 여러 프로젝트를 경험하면서 업무적인 강점으로 발전했습니다.",
  ...
  },
  {
    ...
    paragraphs: [
      "공공·교육기관 프로젝트를 수행하며 Java와 Spring 기반 웹서비스의 개발과 운영을 경험했습니다. 신규 기능 개발, 기존 시스템 개선, 데이터베이스와 SQL 작업, 외부 API 연동 및 운영 장애 대응을 수행하며 실무 역량을 쌓았습니다.",
  ...
  },
  {
    ...
    title: "함께 일하고 싶은 개발자",
    paragraphs: [
      "입사 후 가장 먼저 이루고 싶은 목표는 새로운 서비스와 개발 환경을 빠르게 이해하고 팀에 안정적으로 기여하는 것입니다. 여러 프로젝트의 개발과 운영 경험을 바탕으로 기존 코드를 분석하고 서비스 구조와 업무를 빠르게 파악해 맡은 역할을 책임감 있게 수행하겠습니다.",
