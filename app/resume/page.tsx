...
const coverLetters = [
  ...
  },
  {
    ...
    paragraphs: [
      "저의 가장 큰 강점은 사람들과 자연스럽게 어울리고 적극적으로 소통하는 능력입니다. 먼저 다가가 대화를 시작하는 편이며, 새로운 환경에서도 구성원들과 빠르게 관계를 형성합니다. 이러한 성격은 다채움, CSAP 기준 대응 알콩, 늘봄학교, 기초학력 진단·보정 서비스를 개발하고 운영하면서 업무적인 강점으로 발전했습니다.",
