...
const experiences = [
  {
    ...
    description: "공공 교육 플랫폼을 구축·운영하는 회사로, 다채움, 알콩(CSAP), 늘봄학교, 기초학력 진단·보정, 강원도 진로교육 서비스의 개발과 운영을 담당하고 있습니다.",
  },
  {
...
const coverLetters = [
  {
    ...
    paragraphs: [
      ...
      "이후 공공 교육 플랫폼 제작사인 데이터이음에서 다채움, 알콩(CSAP), 늘봄학교, 기초학력 진단·보정, 강원도 진로교육 서비스를 개발하고 운영하며 실무 경험을 쌓았습니다. 처음에는 주어진 기능을 정확하게 구현하는 것이 가장 중요한 목표였지만, 각기 다른 사용자와 업무 흐름을 가진 서비스를 경험하면서 개발자의 역할은 단순히 코드를 작성하는 것에 그치지 않는다는 것을 배웠습니다.",
      ...
      "다채움과 알콩(CSAP), 늘봄학교 등 교육 서비스에서는 하나의 기능도 여러 담당자의 협의와 검토를 거치는 경우가 많았습니다. 기획자, 퍼블리셔, 개발자, 인프라 담당자와 협업하면서 요구사항을 정확하게 이해하고 자신의 의견을 명확하게 전달하는 커뮤니케이션의 중요성을 배웠습니다.",
  ...
  },
  {
    ...
    paragraphs: [
      "저의 가장 큰 강점은 사람들과 자연스럽게 어울리고 적극적으로 소통하는 능력입니다. 먼저 다가가 대화를 시작하는 편이며, 새로운 환경에서도 구성원들과 빠르게 관계를 형성합니다. 이러한 성격은 다채움, 알콩(CSAP), 늘봄학교, 기초학력 진단·보정 서비스를 개발하고 운영하면서 업무적인 강점으로 발전했습니다.",
      "하나의 기능을 개발하기 위해서도 기획자, 퍼블리셔, 다른 개발자, 인프라 담당자와 의견을 주고받아야 했고 외부 시스템 연계 과정에서는 다른 업체 개발자와 협의하기도 했습니다.",
      "요구사항이 명확하지 않거나 기존 시스템과 충돌할 때 혼자 판단하기보다 관련 담당자와 내용을 확인하고 가능한 방법을 함께 논의합니다. 제가 이해한 요구사항을 다시 정리해 공유하고, 기술적으로 어려운 부분에는 단순히 불가능하다고 말하기보다 가능한 대안을 제시하는 것을 중요하게 생각합니다.",
      "장애가 발생했을 때도 책임 소재를 구분하기보다 문제를 빠르게 해결하는 것을 우선합니다. 로그와 데이터를 확인하고 파악한 내용을 공유하면서 관련 담당자와 함께 원인을 좁혀왔습니다.",
      "밝고 친화적인 성격을 바탕으로 편하게 의견을 나눌 수 있는 분위기를 만들면서도, 업무에서는 일정과 책임을 중요하게 생각하고 맡은 일은 끝까지 마무리합니다.",
      "앞으로도 기술 전문성을 높이는 동시에 동료들과 적극적으로 의견을 나누고, 기술과 사람을 연결하여 팀이 더 좋은 결과를 만들 수 있도록 기여하겠습니다.",
    ],
  },
  {
    label: "지원동기",
    ...
    paragraphs: [
      "다채움, 알콩(CSAP), 늘봄학교, 기초학력 진단·보정, 강원도 진로교육 서비스를 수행하며 Java와 Spring 기반 웹서비스의 개발과 운영을 경험했습니다. 신규 기능 개발, 기존 시스템 개선, 데이터베이스와 SQL 작업, 외부 API 연동 및 운영 장애 대응을 수행하며 실무 역량을 쌓았습니다.",
  ...
  },
  {
    ...
    title: "함께 일하고 싶은 개발자",
    paragraphs: [
      "입사 후 가장 먼저 이루고 싶은 목표는 새로운 서비스와 개발 환경을 빠르게 이해하고 팀에 안정적으로 기여하는 것입니다. 다채움, 알콩(CSAP), 늘봄학교, 기초학력 진단·보정, 강원도 진로교육 서비스의 개발·운영 경험을 바탕으로 기존 코드를 분석하고 서비스 구조와 업무를 빠르게 파악해 맡은 역할을 책임감 있게 수행하겠습니다.",
