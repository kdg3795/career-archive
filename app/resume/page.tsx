...
const coverLetters = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "장기적으로는 맡은 기능을 구현하는 데 그치지 않고 서비스 전반의 구조와 운영 맥락을 이해하며, 기술적 판단의 근거와 경험을 팀에 공유하는 개발자가 되겠습니다. 문제가 발생하면 로그와 데이터를 기반으로 원인을 주도적으로 좁히고 실행 가능한 대안을 제시해, 팀의 의사결정과 안정적인 서비스 운영에 기여하겠습니다.",
